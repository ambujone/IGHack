...
var GameState = {
  ...
  create: function() {
    ...
    this.pet.customParams = {health: 100, fun: 10};
    ...
    this.candy.customParams = {health: 20, fun: -3};
    this.candy.inputEnabled = true;
    this.candy.events.onInputDown.add(this.pickItem, this);

    this.toy = this.game.add.sprite(216, 570, 'toy');
    this.toy.anchor.setTo(0.5);
    this.toy.customParams = {health: 20, fun: 3};
    ...
    this.game.add.text(10, 20, "Investment:", style);
    this.game.add.text(160, 20, "Return:", style);

    this.healthText = this.game.add.text(115, 20, "", style);
    this.funText = this.game.add.text(225, 20, "", style);
    this.refreshStats();
  ...
  reduceProperties: function() {
    this.pet.customParams.health = Math.max(0, this.pet.customParams.health);
    this.pet.customParams.fun = Math.max(0, this.pet.customParams.fun);
    this.refreshStats();
  },
